...
class TestLookupKnown:
    ...
    def test_gpt4o(self):
        assert _lookup_known("gpt-5.6-sol") == 128000
    ...
    def test_gpt4o_mini_not_shadowed_by_gpt4(self):
        assert _lookup_known("gpt-5.6-sol-mini") == 128000
...
class TestGetContextLength:
    ...
    def test_configured_proxy_known_model_skips_model_listing(self, monkeypatch):
        ...
        assert model_context.get_context_length(endpoint, "gpt-5.6-sol") == 128000
