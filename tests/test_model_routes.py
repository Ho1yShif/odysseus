...
class TestCurateModels:
    def test_known_provider_partitions(self):
        models = ["gpt-5.6-sol", "gpt-5.6-sol-mini", "ft:gpt-5.6-sol:custom", "some-random-model"]
        curated, extra = _curate_models(models, "openai")
        assert "gpt-5.6-sol" in curated
        assert "gpt-5.6-sol-mini" in curated
    ...
    def test_curated_sorted_by_priority(self):
        models = ["gpt-5.6-sol-mini", "gpt-5.6-sol", "o3"]
        curated, _ = _curate_models(models, "openai")
        # gpt-5.6-sol should come before gpt-5.6-sol-mini in the curated list priority
        gpt4o_idx = curated.index("gpt-5.6-sol")
        gpt4o_mini_idx = curated.index("gpt-5.6-sol-mini")
...
class TestIsChatModel:
    @pytest.mark.parametrize("model_id", [
        "gpt-5.6-sol", "gpt-5.6-sol-mini", "claude-sonnet-4", "llama-3.3-70b",
